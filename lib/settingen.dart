...
class ParametresEnseignant extends StatefulWidget {
  final int idenseignant;
  const ParametresEnseignant({Key? key, required this.idenseignant}) : super(key: key);

  @override
  State<ParametresEnseignant> createState() => _ParametresEtudiantState();
}

class _ParametresEtudiantState extends State<ParametresEnseignant> {
  ...
  final response = await Supabase.instance.client
      ...
      .eq('id_prof', widget.idenseignant)
      .maybeSingle();
          ...
          : Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [const Color.fromARGB(255, 209, 208, 208), Color.fromARGB(255, 63, 37, 99)],

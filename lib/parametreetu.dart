...
class ParametresEtudiant extends StatefulWidget {
  final int idEtudiant;
  const ParametresEtudiant({Key? key, required this.idEtudiant}) : super(key: key);

  @override
  State<ParametresEtudiant> createState() => _ParametresEtudiantState();
}

class _ParametresEtudiantState extends State<ParametresEtudiant> {
          ...
          : Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [const Color.fromARGB(255, 209, 208, 208), Color.fromARGB(255, 81, 178, 223)],
